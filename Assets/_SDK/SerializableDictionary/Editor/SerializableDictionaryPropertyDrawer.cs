...
namespace _SDK.SerializableDictionary.Editor
{
	public class SerializableDictionaryPropertyDrawer : PropertyDrawer
	{
		...
		private static GUIContent _sIconPlus = IconContent ("Toolbar Plus", "Add entry");
		private static GUIContent _sIconMinus = IconContent ("Toolbar Minus", "Remove entry");
		private static GUIContent _warningIconConflict = IconContent ("console.warnicon.sml", "Conflicting key, this entry will be lost");
		private static GUIContent _sWarningIconOther = IconContent ("console.infoicon.sml", "Conflicting key");
		private static GUIContent _sWarningIconNull = IconContent ("console.warnicon.sml", "Null key, this entry will be lost");
		private static GUIStyle _sButtonStyle = GUIStyle.none;
		...
		private static Dictionary<PropertyIdentity, ConflictState> _sConflictStateDict = new Dictionary<PropertyIdentity, ConflictState>();
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			if (property.isExpanded)
			{
				...
				foreach(var entry in EnumerateEntries(keyArrayProperty, valueArrayProperty))
				{
					...
					{
						var iconPosition = linePosition;
						iconPosition.size =  _sButtonStyle.CalcSize(_warningIconConflict);
		...
		private static Dictionary<SerializedPropertyType, PropertyInfo> _sSerializedPropertyValueAccessorsDict;
